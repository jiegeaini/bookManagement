...
public interface BookService {
	...
	/**
	 * @function 图书增加
	 * @param book categoryName authorName
	 */
	void addBook(Book book,String categoryName,String authorName);
	/**
	 * @function 图书删除
	 * @param id 图书id 
	 */
	 ...
	 * @param book categoryName authorName
	 */
	void updateBook(Book book,String categoryName,String authorName);
	/**
	 * @function 获取所有图书
	 * @return Book 图书实体类 
	 */
